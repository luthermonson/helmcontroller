...
//             },
//             GetFunc: func(namespace string, name string, options v1.GetOptions) (*v1.Job, error) {
...
//             },
//             ListFunc: func(namespace string, opts v1.ListOptions) (*v1.JobList, error) {
...
//             },
//             PatchFunc: func(namespace string, name string, pt types.PatchType, data []byte, subresources ...string) (*v1.Job, error) {
...
func (mock *JobControllerMock) Create(in1 *v1.Job) (*v1.Job, error) {
...
func (mock *JobControllerMock) Delete(namespace string, name string, options *v1.DeleteOptions) error {
...
// Get calls GetFunc.
func (mock *JobControllerMock) Get(namespace string, name string, options v1.GetOptions) (*v1.Job, error) {
	if mock.GetFunc == nil {
...
// List calls ListFunc.
func (mock *JobControllerMock) List(namespace string, opts v1.ListOptions) (*v1.JobList, error) {
...
func (mock *JobControllerMock) Patch(namespace string, name string, pt types.PatchType, data []byte, subresources ...string) (*v1.Job, error) {
...
func (mock *JobControllerMock) Update(in1 *v1.Job) (*v1.Job, error) {
...
func (mock *JobControllerMock) UpdateStatus(in1 *v1.Job) (*v1.Job, error) {
...
func (mock *JobControllerMock) Watch(namespace string, opts v1.ListOptions) (watch.Interface, error) {
...
// Create calls CreateFunc.
func (mock *JobClientMock) Create(in1 *v1.Job) (*v1.Job, error) {
	if mock.CreateFunc == nil {
...
// Delete calls DeleteFunc.
func (mock *JobClientMock) Delete(namespace string, name string, options *v1.DeleteOptions) error {
	if mock.DeleteFunc == nil {
...
// Get calls GetFunc.
func (mock *JobClientMock) Get(namespace string, name string, options v1.GetOptions) (*v1.Job, error) {
	if mock.GetFunc == nil {
...
// List calls ListFunc.
func (mock *JobClientMock) List(namespace string, opts v1.ListOptions) (*v1.JobList, error) {
	if mock.ListFunc == nil {
...
// Patch calls PatchFunc.
func (mock *JobClientMock) Patch(namespace string, name string, pt types.PatchType, data []byte, subresources ...string) (*v1.Job, error) {
	if mock.PatchFunc == nil {
...
// Update calls UpdateFunc.
func (mock *JobClientMock) Update(in1 *v1.Job) (*v1.Job, error) {
	if mock.UpdateFunc == nil {
...
// UpdateStatus calls UpdateStatusFunc.
func (mock *JobClientMock) UpdateStatus(in1 *v1.Job) (*v1.Job, error) {
	if mock.UpdateStatusFunc == nil {
...
// Watch calls WatchFunc.
func (mock *JobClientMock) Watch(namespace string, opts v1.ListOptions) (watch.Interface, error) {
	if mock.WatchFunc == nil {
...
// 	               panic("mock out the Get method")
//             },
//             GetByIndexFunc: func(indexName string, key string) ([]*v1.Job, error) {
...
// Get calls GetFunc.
func (mock *JobCacheMock) Get(namespace string, name string) (*v1.Job, error) {
	if mock.GetFunc == nil {
...
func (mock *JobCacheMock) GetByIndex(indexName string, key string) ([]*v1.Job, error) {
...
// List calls ListFunc.
func (mock *JobCacheMock) List(namespace string, selector labels.Selector) ([]*v1.Job, error) {
	if mock.ListFunc == nil {
