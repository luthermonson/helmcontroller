...
//             },
//             GetFunc: func(name string, options v1.GetOptions) (*v1.ClusterRoleBinding, error) {
...
//             },
//             ListFunc: func(opts v1.ListOptions) (*v1.ClusterRoleBindingList, error) {
...
//             },
//             PatchFunc: func(name string, pt types.PatchType, data []byte, subresources ...string) (*v1.ClusterRoleBinding, error) {
...
func (mock *ClusterRoleBindingControllerMock) Create(in1 *v1.ClusterRoleBinding) (*v1.ClusterRoleBinding, error) {
...
func (mock *ClusterRoleBindingControllerMock) Delete(name string, options *v1.DeleteOptions) error {
...
// Get calls GetFunc.
func (mock *ClusterRoleBindingControllerMock) Get(name string, options v1.GetOptions) (*v1.ClusterRoleBinding, error) {
	if mock.GetFunc == nil {
...
// List calls ListFunc.
func (mock *ClusterRoleBindingControllerMock) List(opts v1.ListOptions) (*v1.ClusterRoleBindingList, error) {
...
func (mock *ClusterRoleBindingControllerMock) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (*v1.ClusterRoleBinding, error) {
...
func (mock *ClusterRoleBindingControllerMock) Update(in1 *v1.ClusterRoleBinding) (*v1.ClusterRoleBinding, error) {
...
func (mock *ClusterRoleBindingControllerMock) Watch(opts v1.ListOptions) (watch.Interface, error) {
...
// Create calls CreateFunc.
func (mock *ClusterRoleBindingClientMock) Create(in1 *v1.ClusterRoleBinding) (*v1.ClusterRoleBinding, error) {
	if mock.CreateFunc == nil {
...
// Delete calls DeleteFunc.
func (mock *ClusterRoleBindingClientMock) Delete(name string, options *v1.DeleteOptions) error {
	if mock.DeleteFunc == nil {
...
// Get calls GetFunc.
func (mock *ClusterRoleBindingClientMock) Get(name string, options v1.GetOptions) (*v1.ClusterRoleBinding, error) {
	if mock.GetFunc == nil {
...
// List calls ListFunc.
func (mock *ClusterRoleBindingClientMock) List(opts v1.ListOptions) (*v1.ClusterRoleBindingList, error) {
	if mock.ListFunc == nil {
...
// Patch calls PatchFunc.
func (mock *ClusterRoleBindingClientMock) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (*v1.ClusterRoleBinding, error) {
	if mock.PatchFunc == nil {
...
// Update calls UpdateFunc.
func (mock *ClusterRoleBindingClientMock) Update(in1 *v1.ClusterRoleBinding) (*v1.ClusterRoleBinding, error) {
	if mock.UpdateFunc == nil {
...
// Watch calls WatchFunc.
func (mock *ClusterRoleBindingClientMock) Watch(opts v1.ListOptions) (watch.Interface, error) {
	if mock.WatchFunc == nil {
...
//             },
//             GetFunc: func(name string) (*v1.ClusterRoleBinding, error) {
// 	               panic("mock out the Get method")
//             },
//             GetByIndexFunc: func(indexName string, key string) ([]*v1.ClusterRoleBinding, error) {
// 	               panic("mock out the GetByIndex method")
//             },
//             ListFunc: func(selector labels.Selector) ([]*v1.ClusterRoleBinding, error) {
// 	               panic("mock out the List method")
//             },
//         }
//
...
// Get calls GetFunc.
func (mock *ClusterRoleBindingCacheMock) Get(name string) (*v1.ClusterRoleBinding, error) {
	if mock.GetFunc == nil {
...
func (mock *ClusterRoleBindingCacheMock) GetByIndex(indexName string, key string) ([]*v1.ClusterRoleBinding, error) {
...
// List calls ListFunc.
func (mock *ClusterRoleBindingCacheMock) List(selector labels.Selector) ([]*v1.ClusterRoleBinding, error) {
	if mock.ListFunc == nil {
