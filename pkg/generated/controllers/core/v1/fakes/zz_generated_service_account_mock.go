...
import (
	...
	v1 "github.com/rancher/helmcontroller/pkg/generated/controllers/core/v1"
...
//             },
//             GetFunc: func(namespace string, name string, options v1.GetOptions) (*v1.ServiceAccount, error) {
...
//             },
//             ListFunc: func(namespace string, opts v1.ListOptions) (*v1.ServiceAccountList, error) {
...
//             },
//             PatchFunc: func(namespace string, name string, pt types.PatchType, data []byte, subresources ...string) (*v1.ServiceAccount, error) {
...
func (mock *ServiceAccountControllerMock) Create(in1 *v1.ServiceAccount) (*v1.ServiceAccount, error) {
...
func (mock *ServiceAccountControllerMock) Delete(namespace string, name string, options *v1.DeleteOptions) error {
...
// Get calls GetFunc.
func (mock *ServiceAccountControllerMock) Get(namespace string, name string, options v1.GetOptions) (*v1.ServiceAccount, error) {
	if mock.GetFunc == nil {
...
// List calls ListFunc.
func (mock *ServiceAccountControllerMock) List(namespace string, opts v1.ListOptions) (*v1.ServiceAccountList, error) {
...
func (mock *ServiceAccountControllerMock) Patch(namespace string, name string, pt types.PatchType, data []byte, subresources ...string) (*v1.ServiceAccount, error) {
...
func (mock *ServiceAccountControllerMock) Update(in1 *v1.ServiceAccount) (*v1.ServiceAccount, error) {
...
func (mock *ServiceAccountControllerMock) Watch(namespace string, opts v1.ListOptions) (watch.Interface, error) {
...
// Create calls CreateFunc.
func (mock *ServiceAccountClientMock) Create(in1 *v1.ServiceAccount) (*v1.ServiceAccount, error) {
	if mock.CreateFunc == nil {
...
// Delete calls DeleteFunc.
func (mock *ServiceAccountClientMock) Delete(namespace string, name string, options *v1.DeleteOptions) error {
	if mock.DeleteFunc == nil {
...
// Get calls GetFunc.
func (mock *ServiceAccountClientMock) Get(namespace string, name string, options v1.GetOptions) (*v1.ServiceAccount, error) {
	if mock.GetFunc == nil {
...
// List calls ListFunc.
func (mock *ServiceAccountClientMock) List(namespace string, opts v1.ListOptions) (*v1.ServiceAccountList, error) {
	if mock.ListFunc == nil {
...
// Patch calls PatchFunc.
func (mock *ServiceAccountClientMock) Patch(namespace string, name string, pt types.PatchType, data []byte, subresources ...string) (*v1.ServiceAccount, error) {
	if mock.PatchFunc == nil {
...
// Update calls UpdateFunc.
func (mock *ServiceAccountClientMock) Update(in1 *v1.ServiceAccount) (*v1.ServiceAccount, error) {
	if mock.UpdateFunc == nil {
...
// Watch calls WatchFunc.
func (mock *ServiceAccountClientMock) Watch(namespace string, opts v1.ListOptions) (watch.Interface, error) {
	if mock.WatchFunc == nil {
...
// 	               panic("mock out the Get method")
//             },
//             GetByIndexFunc: func(indexName string, key string) ([]*v1.ServiceAccount, error) {
...
// Get calls GetFunc.
func (mock *ServiceAccountCacheMock) Get(namespace string, name string) (*v1.ServiceAccount, error) {
	if mock.GetFunc == nil {
...
func (mock *ServiceAccountCacheMock) GetByIndex(indexName string, key string) ([]*v1.ServiceAccount, error) {
...
// List calls ListFunc.
func (mock *ServiceAccountCacheMock) List(namespace string, selector labels.Selector) ([]*v1.ServiceAccount, error) {
	if mock.ListFunc == nil {
